 ...
 *      1）Spring Async：
 *          {@link com.wmt.framework.quartz.config.AhzxAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 AhzxSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.wmt.framework.tenant;
