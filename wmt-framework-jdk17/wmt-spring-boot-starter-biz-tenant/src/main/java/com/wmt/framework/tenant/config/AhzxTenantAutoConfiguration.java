package com.wmt.framework.tenant.config;
...
import com.wmt.framework.redis.config.AhzxCacheProperties;
import com.wmt.framework.security.core.service.SecurityFrameworkService;
import com.wmt.framework.tenant.core.aop.TenantIgnore;
import com.wmt.framework.tenant.core.aop.TenantIgnoreAspect;
import com.wmt.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.wmt.framework.tenant.core.job.TenantJobAspect;
import com.wmt.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.wmt.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.wmt.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.wmt.framework.tenant.core.redis.TenantRedisCacheManager;
import com.wmt.framework.tenant.core.security.TenantSecurityWebFilter;
import com.wmt.framework.tenant.core.service.TenantFrameworkService;
import com.wmt.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.wmt.framework.tenant.core.web.TenantContextWebFilter;
import com.wmt.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "ahzx.tenant", value = "enable", matchIfMissing = true) // 允许使用 ahzx.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class AhzxTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     AhzxCacheProperties ahzxCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(ahzxCacheProperties.getRedisScanBatchSize()));
