package com.wmt.framework.jackson.config;

import com.wmt.framework.common.util.json.JsonUtils;
import com.wmt.framework.common.util.json.databind.NumberSerializer;
import com.wmt.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.wmt.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class AhzxJacksonAutoConfiguration {
