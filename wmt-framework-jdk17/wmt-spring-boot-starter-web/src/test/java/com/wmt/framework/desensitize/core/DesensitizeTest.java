package com.wmt.framework.desensitize.core;

import com.wmt.framework.common.util.json.JsonUtils;
import com.wmt.framework.desensitize.core.annotation.Address;
import com.wmt.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.wmt.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.wmt.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("wmt");
        ...
        desensitizeDemo.setRegex("你好，我是wmt");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("wmt");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "wmt", replacer = "*")
