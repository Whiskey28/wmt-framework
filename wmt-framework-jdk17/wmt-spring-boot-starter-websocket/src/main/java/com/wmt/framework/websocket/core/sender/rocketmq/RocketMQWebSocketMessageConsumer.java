package com.wmt.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${ahzx.websocket.sender-rocketmq.topic}",
        consumerGroup = "${ahzx.websocket.sender-rocketmq.consumer-group}",
