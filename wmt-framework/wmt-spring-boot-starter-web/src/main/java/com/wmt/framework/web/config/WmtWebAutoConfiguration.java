...
public class WmtWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "wmt.log.aspect", value = "enable", matchIfMissing = true)
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "wmt.demo", havingValue = "true")
