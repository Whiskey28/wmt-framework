...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("tdc");
        ...
        desensitizeDemo.setRegex("你好，我是tdc");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("tdc");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "tdc", replacer = "*")
