 ...
 *      1）Spring Async：
 *          {@link com.wmt.framework.quartz.config.WmtAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 WmtSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
